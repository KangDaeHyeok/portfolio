...
<head>
<meta charset="UTF-8">
<title>회원가입 | 한국도로공사 하이패스 배구단</title>
<!-- 파비콘 -->
...
<body>
	<div id="join_wrapper" class="tot_wrap">
		<%@include file="../header.jsp" %>
		<section id="main">
			<div class="p_wrapper">
				<p class="uppercase italic bo">join</p>
				<h1 class="bo">회원가입</h1>
		...
		<section id="join">
			<div class="join_wrapper">
				<div class="form_wrap">
					<form action="/joinMember" name="join_form" method="post">
						<div class="input_wrap">
							...
							<div class="zip_code_wrap">
								...
								<input type="text" name="zip_code" id="zip_code" onclick="post()"/>
							</div>
