...
%>
	<div class="container-fluid p-0">
		...
		<div class="row pb-5 mb-5">
			...
			<div class="col-md-4 col-6">
				<div class="thumbnail">
					<img src='../resources/images/ev/<%=rs.getString("car_image")%>'
						alt="" class="img-fluid">
					<div class="caption text-center">
						<h3><%=rs.getString("carname")%></h3>
						<p><%=NumberFormat.getInstance().format(Integer.parseInt(rs.getString("price")))%>
							원 ~
						</p>
						<p>
							<%
							...
							%>
							<input type="hidden" value="<%=rs.getString("carname") %>" id="delV" />
	...
	<script
		...
		function deleteMember() {
			...
			var del = $("#delV").val();
			if (confirmflag) {
				location.href = 'DeleteCar.ad?carname=' + del;
